...
from django.db.models.signals import post_init, post_save, pre_save, pre_delete, m2m_changed
...
class Answer(models.Model):
	...
	def calculate_grade(self):
		grade_percent = 0.5 + (float(question.max_tries - total_tries) / question.max_tries)/2
		if total_tries > question.max_tries:
			grade_percent = 0
		grade = grade_percent * question.marks
